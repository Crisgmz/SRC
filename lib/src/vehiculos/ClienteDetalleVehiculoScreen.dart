...
class ClienteDetalleVehiculoScreen extends StatefulWidget {
  ...
  const ClienteDetalleVehiculoScreen({super.key, required this.idVehiculo});

  @override
  State<ClienteDetalleVehiculoScreen> createState() =>
      _ClienteDetalleVehiculoScreenState();
}

class _ClienteDetalleVehiculoScreenState
    extends State<ClienteDetalleVehiculoScreen>
  ...
  void initState() {
    ...
    _loadVehiculoData();
    _loadUserData(); // 👈 agrega esta función
  }
                      ...
                      ElevatedButton(
                        onPressed: () {
                          Navigator.push(
                            ...
                            MaterialPageRoute(
                              builder:
                                  (_) => SeleccionFechaHoraScreen(
                                    idVehiculo:
                                        vehiculoData!['idVehiculo'] ??
                                        widget.idVehiculo,
                                    ...
                                    precioPorDia:
                                        ...
                                        0,
                                    imagenes: vehiculoData!['imagenes'] ?? [],
